...
<div class="row pagelist-form">
	...
	<fieldset>
		<div class='form-group'>
			<label><?php echo t('Results Page')?>:</label>
			<?php
			echo  Loader::helper('form/page_selector')->selectPage('postTo_cID', $postTo_cID); ?>
		</div>
	</fieldset>
	
	</fieldset>
		<div class="form-group">
            <label class="control-label"><?php echo t('Maximum Number of Tags') ?></label>
            <input type="text" maxwidth="30" maxlength="3" class="form-control" name="max_tags" value="<?php echo $max_tags?>" />
        </div>
		
		<div class="form-group">
            <label class="control-label"><?php echo t('Minimum Height of Tags') ?></label>
            <input type="text" maxwidth="30" maxlength="3" class="form-control" name="min_height" value="<?php echo $min_height?>" />
        </div>
		
		<div class="form-group">
            <label class="control-label"><?php echo t('Maximum Height of Tags') ?></label>
            <input type="text" maxwidth="30" maxlength="3" class="form-control" name="max_height" value="<?php echo $max_height?>"  />
        </div>
	</fieldset>
